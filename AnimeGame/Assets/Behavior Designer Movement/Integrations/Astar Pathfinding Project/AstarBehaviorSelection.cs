    ...
    private string Description()
    {
        ...
        switch (selectionType)
        {
            case BehaviorSelectionType.Seek:
                desc =
                    "The Seek task will move the agent towards the target with pathfinding. In this example the green agent is seeking the red dot (which moves).";
                break;
            case BehaviorSelectionType.Flee:
                desc =
                    "The Flee task will move the agent away from the target with pathfinding. In this example the green agent is fleeing from red dot (which moves).";
                break;
            ...
            case BehaviorSelectionType.Follow:
                desc =
                    "The Follow task will allow the agent to continuously follow a GameObject. In this example the green agent is following the red dot.";
                break;
            case BehaviorSelectionType.Patrol:
                desc =
                    "The Patrol task moves from waypoint to waypint. In this example the green agent is patrolling with four different waypoints (the white dots).";
                break;
            case BehaviorSelectionType.Cover:
                desc =
                    "The Cover task will move the agent into cover from its current position. In this example the agent sees cover in front of it so takes cover behind the wall.";
                break;
            ...
            case BehaviorSelectionType.Search:
                desc =
                    "The Search task will search the map by wandering until it finds the target. It can find the target by seeing or hearing the target. In this example the Search task is looking for the red dot.";
                break;
            case BehaviorSelectionType.Flock:
                desc =
                    "The Flock task moves a group of objects together in a pattern (which can be adjusted). In this example the Flock task is controlling all 30 objects.";
                break;
            case BehaviorSelectionType.LeaderFollow:
                desc =
                    "The Leader Follow task moves a group of objects behind a leader object. There are two behavior trees running in this example - one for the leader (who is patrolling the area) and one for the group of objects.";
                break;
            case BehaviorSelectionType.Queue:
                desc =
                    "The Queue task will move a group of objects through a small space in an organized way. In this example the Queue task is controlling all of the objects. Another way to move all of the objects through the doorway is with the seek task, however with this approach the objects would group up at hte doorway.";
                break;
        }
    ...
    private void SelectionChanged()
    {
        ...
        switch (selectionType)
        {
            case BehaviorSelectionType.Seek:
                ...
                mainBot.transform.position = new Vector3(-20, 0, -20);
            ...
            case BehaviorSelectionType.Flee:
                ...
                mainBot.transform.position = new Vector3(10, 0, 18);
                mainBot.transform.eulerAngles = new Vector3(0, 180, 0);
                mainBot.SetActive(true);
                StartCoroutine("EnableBehavior");
                break;
            ...
            case BehaviorSelectionType.Evade:
                ...
                mainBot.transform.position = new Vector3(0, 0, 18);
                mainBot.transform.eulerAngles = new Vector3(0, 180, 0);
                mainBot.SetActive(true);
                StartCoroutine("EnableBehavior");
                break;
            case BehaviorSelectionType.Follow:
                ...
                mainBot.transform.position = new Vector3(20, 0, 15);
            ...
            case BehaviorSelectionType.Patrol:
                ...
                break;
            case BehaviorSelectionType.Cover:
                mainBot.transform.position = new Vector3(-5, 0, -10);
                mainBot.transform.eulerAngles = new Vector3(0, 0, 0);
                mainBot.SetActive(true);
                StartCoroutine("EnableBehavior");
                break;
            ...
            case BehaviorSelectionType.LeaderFollow:
                ...
                mainBot.transform.position = new Vector3(0, 0, -130);
                mainBot.SetActive(true);
                Camera.main.transform.position = new Vector3(0, 90, -150);
                for (int i = 0; i < followGroup.transform.childCount; ++i)
                {
