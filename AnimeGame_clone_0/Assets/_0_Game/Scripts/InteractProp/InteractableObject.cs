...
public class InteractableObject : NetworkBehaviour , IInteract
{
    ...
    public readonly SyncVar<bool> canInteract = new SyncVar<bool>();
    public readonly SyncVar<bool> isInteracting = new SyncVar<bool>();
    ...
    public void SetCanInteract(bool canInteract) => this.canInteract.Value = canInteract;
    
    [ServerRpc(RequireOwnership = false)]
    public void SetIsInteracting(bool isInteracting) => this.isInteracting.Value = isInteracting;
    ...
    public void GetItem()
    {
        ...
        {
            GameManager.Instance.playerPresenter.PickUp();
        }
