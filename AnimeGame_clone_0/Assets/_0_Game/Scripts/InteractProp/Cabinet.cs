...
namespace AnimeGame
{
    public class Cabinet : InteractableObject
    {
        ...
        {
            if (!canInteract.Value || isInteracted)
                return;
        ...
        public void ComeOut()
        {
            ...
            GameManager.Instance.playerPresenter.transform.SetPositionAndRotation(characterComeOutTransform.position,characterComeOutTransform.rotation);
